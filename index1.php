...
<script>
    function jc() {
        if (form1.fs.value=="yj"){
            ...
            if(form1.cz.value=="") {
                alert("请选择刻章材质！");form1.cz,focus();return false;
            }
            if(form1.fs.value=="") {
            ...
            if(form1.kzt.value=="公章"){
                if(form1.gs.value==""){
                    alert("公司名称不能为空！");form1.gs.focus();return false;
                }
            }
            if(form1.kzt.value=="法人章"){
                if(form1.fname.value==""){
                    alert("法人名称不能为空！");form1.fname.focus();return false;
                }
            }
        }
        else{
    ...
    <form name="form1" action="http://www.nbzxapi.com/zxkz/phpapi/example/jsapi.php">
        <div id="container">
            <div class="address_main">
                ...
                <div class="line">
                    <select name="kzt" style="background-color: white" id="kzt" onchange="dcz()">
                ...
                <div id="gln" class="line" style="display: none">
                    <input type="text" placeholder="请填写公司名称" name="gs" id="gs">
                </div>
                <div id="fln" class="line" style="display: none">
                    <input type="text" placeholder="请填写法人名称" name="fname" id="fname">
                </div>
                <center>
